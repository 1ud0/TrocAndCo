    ...
    **/
    _init: function() {
        ...
        **/
        ...
        Y.config.lang = Y.config.lang || 'fr-FR';
...
Y.Loader.prototype = {
    ...
    */
     ...
     * @param {Array} [config.lang] Array of BCP 47 language tags of languages for which this module has localized resource bundles, e.g., `["fr-FR", "zh-Hans-CN"]`
...
// Add rollup file, need to add to supersedes list too
    ...
    * @param {String} packName The name of the package (e.g: lang/datatype-date-fr-FR)
