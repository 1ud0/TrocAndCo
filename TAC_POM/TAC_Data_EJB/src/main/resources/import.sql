...
INSERT INTO `valeur` (`id_valeur`, `intitule`, `valeur`) VALUES (1,'De 0 € 5 €',1);
INSERT INTO `valeur` (`id_valeur`, `intitule`, `valeur`) VALUES (2,'De 5 € 10 €',2);
INSERT INTO `valeur` (`id_valeur`, `intitule`, `valeur`) VALUES (3,'De 10 € 15 €',3);
INSERT INTO `valeur` (`id_valeur`, `intitule`, `valeur`) VALUES (4,'De 15 € 25 €',4);
INSERT INTO `valeur` (`id_valeur`, `intitule`, `valeur`) VALUES (5,'De 25 € 50 €',5);
...
INSERT INTO `etat` (`id_etat`, `intitule`) VALUES (3,'Usagé');
...
INSERT INTO `categorie` (`id_categorie`, `intitule`, `id_categorie_mere`) VALUES (8,'Maison, Déco',NULL);
...
INSERT INTO `categorie` (`id_categorie`, `intitule`, `id_categorie_mere`) VALUES (11,'Mode, Beauté',NULL);
...
INSERT INTO `categorie` (`id_categorie`, `intitule`, `id_categorie_mere`) VALUES (22,'Vinyles',2);
...
INSERT INTO `categorie` (`id_categorie`, `intitule`, `id_categorie_mere`) VALUES (35,'Accessoires mobile',5);
...
INSERT INTO `categorie` (`id_categorie`, `intitule`, `id_categorie_mere`) VALUES (48,'Gros électroménager',8);
INSERT INTO `categorie` (`id_categorie`, `intitule`, `id_categorie_mere`) VALUES (49,'Petit électroménager',8);
...
INSERT INTO `categorie` (`id_categorie`, `intitule`, `id_categorie_mere`) VALUES (53,'Décoration',8);
...
INSERT INTO `membre` (`id_membre`, `nom`, `prenom`, `date_naissance`, `date_inscription`, `avatar`, `mail`, `telephone`, `date_desinscription`, `date_radiation`, `motif_radiation`, `pseudo`, `password`, `compte_id`) VALUES (14,'Travis','Ed','1956-12-25','2017-04-04','img/imgAvatar/avatarNew2.jpg','travis.ed@gmail.com','0234589566',NULL,NULL,NULL,'Travis','pass',2);
INSERT INTO `membre` (`id_membre`, `nom`, `prenom`, `date_naissance`, `date_inscription`, `avatar`, `mail`, `telephone`, `date_desinscription`, `date_radiation`, `motif_radiation`, `pseudo`, `password`, `compte_id`) VALUES (15,'Doe','John','1976-04-26','2017-04-05','img/imgAvatar/avatarNew3.jpg','doe.john@gmail.com','0324565464',NULL,NULL,NULL,'Doe','pass',2);
INSERT INTO `membre` (`id_membre`, `nom`, `prenom`, `date_naissance`, `date_inscription`, `avatar`, `mail`, `telephone`, `date_desinscription`, `date_radiation`, `motif_radiation`, `pseudo`, `password`, `compte_id`) VALUES (16,'Sparrow','Jack','1992-03-25','2017-04-06','img/imgAvatar/sparrow.jpg','sparrow.jack@gmail.com','0165465462',NULL,NULL,NULL,'Sparrow','pass',2);
INSERT INTO `membre` (`id_membre`, `nom`, `prenom`, `date_naissance`, `date_inscription`, `avatar`, `mail`, `telephone`, `date_desinscription`, `date_radiation`, `motif_radiation`, `pseudo`, `password`, `compte_id`) VALUES (17,'Lama','Serge','1966-06-06','2017-04-07','img/imgAvatar/avatarNew5.jpg','lama.serge@gmail.com','0324598466',NULL,NULL,NULL,'Lama','pass',2);
...
INSERT INTO `membre` (`id_membre`, `nom`, `prenom`, `date_naissance`, `date_inscription`, `avatar`, `mail`, `telephone`, `date_desinscription`, `date_radiation`, `motif_radiation`, `pseudo`, `password`, `compte_id`) VALUES (20,'Smith','Black','1967-08-18','2017-04-10','img/imgAvatar/avatarNew6.jpg','smith.black@gmail.com','0694645541','2017-04-15',NULL,NULL,'Smith','pass',2);
INSERT INTO `membre` (`id_membre`, `nom`, `prenom`, `date_naissance`, `date_inscription`, `avatar`, `mail`, `telephone`, `date_desinscription`, `date_radiation`, `motif_radiation`, `pseudo`, `password`, `compte_id`) VALUES (21,'Sauron','Zigur','1937-08-18','2017-04-11','img/imgAvatar/avatar1.png','sauron.zigur@gmail.com','0694645541',NULL,NULL,NULL,'Sauron','pass',2);
INSERT INTO `membre` (`id_membre`, `nom`, `prenom`, `date_naissance`, `date_inscription`, `avatar`, `mail`, `telephone`, `date_desinscription`, `date_radiation`, `motif_radiation`, `pseudo`, `password`, `compte_id`) VALUES (22,'Gollum','Smeagol','1937-08-18','2017-04-11','img/imgAvatar/gollum.jpg','gullum.smeagol@gmail.com','0694645541',NULL,NULL,NULL,'Gullum','pass',2);
INSERT INTO `membre` (`id_membre`, `nom`, `prenom`, `date_naissance`, `date_inscription`, `avatar`, `mail`, `telephone`, `date_desinscription`, `date_radiation`, `motif_radiation`, `pseudo`, `password`, `compte_id`) VALUES (23,'Diallo','Agnes','1985-08-18','2017-04-11','img/imgAvatar/avatar agnes3.jpg','agnes.diallo@gmail.com','0694645541',NULL,NULL,NULL,'Agnes','pass',2);
INSERT INTO `membre` (`id_membre`, `nom`, `prenom`, `date_naissance`, `date_inscription`, `avatar`, `mail`, `telephone`, `date_desinscription`, `date_radiation`, `motif_radiation`, `pseudo`, `password`, `compte_id`) VALUES (24,'Pericard','Sebastien','1985-08-18','2017-04-11','img/imgAvatar/avatar seb.jpg','seb.pericard@gmail.com','0694645541',NULL,NULL,NULL,'Seb','pass',2);

/*============================*/
/*		TABLE PROPOSITION	  */
/*============================*/

INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (1,'Pot',1,1,1,12,71,'Pot rose pour bébé','2017-04-01 00:02:00');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (2,'Disque dur',2,1,1,6,41,'Disque dur super performant!','2017-04-01 10:00:00');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (3,'Chaise Louis XVI',3,1,2,8,52,'Chaise de Luxe!','2017-05-01 10:00:00');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (5,'Chaussures',4,2,6,11,69,'Chaussures taille 40','2017-03-01 10:00:00');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (6,'Chaton',1,1,6,9,59,'Chat noir','2017-03-01 12:00:00');
...
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (8,'Canard en plastique',2,2,4,12,72,'Tres peu utilisé, couine trop! pratique pour les bains!','2017-04-25 10:00:00');
...
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (12,'Manteau en hermine motif lys',2,5,10,11,66,'Pas piqué des verres','2017-05-09 10:00:00');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (13,'Cadenas',3,2,9,14,85,'Cadenas de luxe du pont des arts','2017-02-03 10:00:00');
...
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (15,'Ballon',1,2,6,10,61,'ballon tout rond','2017-03-01 10:02:00');
...
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (24,'Pièces de lego',4,4,13,12,72,'Moitié de TIE fighter','2017-04-11');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (25,'Peluche',1,1,14,12,72,'Ours gris','2017-04-12');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (26,'Verre à bière',2,2,14,8,50,'Grim','2017-04-13');
...
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (28,'Gants pilote',4,4,15,13,80,'Petite taille','2017-04-15');
...
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (30,'Câble alimentation pc',2,2,15,6,42,'Asus','2017-04-17');
...
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (36,'Collection de timbres',4,4,17,14,82,'300 timbres 1950-2000','2017-04-23');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (37,'Livre dont vous êtes le héros',1,1,18,1,16,'Qui est tué?','2017-04-24');
...
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (40,'VHS des nuls',4,4,19,3,28,'c est null','2017-04-27');
...
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (44,'Binette',3,3,5,9,58,'Binette super chouette couleur cacahuette! ','2017-03-01');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (45,'Tondeuse',3,3,5,9,58,'Tondeuse automatique! ','2017-03-01');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (46,'Pelle',3,3,5,9,58,'Trés belle pelle!','2017-03-01');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (47,'Pot de fleur',3,3,5,9,58,'Petit pot de fleur','2017-03-01');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (48,'Mon précieux',3,3,21,14,85,'Un anneau pour les gouverner tous','2017-05-11');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (49,'Babyfoot',1,4,23,12,72,'Super baby neuf!','2017-05-11');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (50,'Ordinateur portable de competition',3,4,24,6,38,'Asus Rog','2017-04-01 10:00:00');
INSERT INTO `proposition` (`id_proposition`, `intitule`, `etat_id`, `valeur_id`, `membre_id`, `categorie_id`, `sous_categorie_id`, `description`, `date_ajout`) VALUES (51,'Livre de Java',1,3,24,1,18,'Le java pour les nuls','2017-04-01 10:00:00');
...
INSERT INTO `tag` (`id_tag`, `intitule`, `categorie_id`) VALUES (151,'siége',76);
...
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (1,'2017-04-15 00:00:00',1,'ok pour cet objet?',6,11,5);
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (2,'2017-04-15 02:00:00',0,'vous voulez pas répondre? ',6,11,5);
...
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (8,'2017-04-24 13:30:00',0,' Cet objet?',12,17,11);
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (9,'2017-04-24 13:00:00',1,'Cet objet est il dispo ?',16,22,13);
...
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (11,'2017-04-24 13:00:00',1,'Bonjour comment ça va ?',16,37,18);
...
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (13,'2017-04-24 13:15:00',0,'oui!! Demain ? 13h!',16,37,18);
...
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (18,'2017-04-24 13:00:00',1,'Bonjour pourriez me donner plus de précisions sur cet objet ?',15,12,10);
...
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (27,'2017-04-24 13:10:00',1,'Biensur, alors il a ces caractéristiques et cettehistoire!',2,10,13);
...
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (39,'2017-05-10 13:30:00',1,'Il est bien le livre?',23,51,24);
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (40,'2017-05-10 13:35:00',1,'Super livre! et pas cher!',24,51,23);
INSERT INTO `message` (`id_message`, `date_envoi`, `lu`, `texte`, `membre_id_emetteur`, `proposition_id`, `membre_id_recepteur`) VALUES (41,'2017-05-10 13:40:00',1,'Ok je le prends.',23,51,24);
...
INSERT INTO `localisation` (`id_localisation`, `adresse`, `code_postal`, `ville`, `longitude`, `latitude`, `membre_id`, `titre_adresse`) VALUES (26,'35 bis Rue du Borrego',75020,'Paris',2.40107,48.873296,18,'Adresse Principale');
...
INSERT INTO `localisation` (`id_localisation`, `adresse`, `code_postal`, `ville`, `longitude`, `latitude`, `membre_id`, `titre_adresse`) VALUES (29,'44 Rue AFCEPF',92120,'Montrouge',2.327171,48.8164171 ,23,'Travail');
INSERT INTO `localisation` (`id_localisation`, `adresse`, `code_postal`, `ville`, `longitude`, `latitude`, `membre_id`, `titre_adresse`) VALUES (30,'1 Rue de la maison',75018,'Paris',2.329253,48.8922941 ,23,'Adresse Principale');
INSERT INTO `localisation` (`id_localisation`, `adresse`, `code_postal`, `ville`, `longitude`, `latitude`, `membre_id`, `titre_adresse`) VALUES (31,'1 Rue du Java',75009,'Paris',2.358444,48.87924 ,24,'Adresse Principale');
INSERT INTO `localisation` (`id_localisation`, `adresse`, `code_postal`, `ville`, `longitude`, `latitude`, `membre_id`, `titre_adresse`) VALUES (32,'42 Rue AFCEPF',92120,'Montrouge',2.327171,48.8164171 ,24,'Travail');
INSERT INTO `localisation` (`id_localisation`, `adresse`, `code_postal`, `ville`, `longitude`, `latitude`, `membre_id`, `titre_adresse`) VALUES (33,'63 Boulevard Richard Lenoir',75011,'Paris',2.372231,48.860085,21,'Adresse Principale');
INSERT INTO `localisation` (`id_localisation`, `adresse`, `code_postal`, `ville`, `longitude`, `latitude`, `membre_id`, `titre_adresse`) VALUES (34,'63 Boulevard Richard Lenoir',75011,'Paris',2.372231,48.860085,22,'Adresse Principale');
...
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (1,'Ma liste','2017-04-15 00:00:00',NULL,7);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (2,'Ma liste','2017-04-15 00:00:00',NULL,5);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (3,'maison','2017-04-15 00:00:00',NULL,5);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (4,'Ma liste','2017-04-15 00:00:00',NULL,6);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (5,'Ma liste','2017-04-15 00:00:00',NULL,11);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (6,'Ma liste','2017-04-15 00:00:00',NULL,12);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (7,'fille','2017-04-15 00:00:00',NULL,12);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (8,'Ma liste','2017-04-20 00:00:00',NULL,24);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (9,'Ma liste','2017-04-15 00:00:00',NULL,23);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (10,'Ma liste','2017-04-15 00:00:00',NULL,22);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (11,'Ma liste','2017-04-15 00:00:00',NULL,21);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (12,'Ma liste','2017-04-15 00:00:00',NULL,20);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (13,'Ma liste','2017-04-15 00:00:00',NULL,1);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (14,'Ma liste','2017-04-15 00:00:00',NULL,19);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (15,'Ma liste','2017-04-15 00:00:00',NULL,18);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (16,'Ma liste','2017-04-20 00:00:00',NULL,17);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (17,'Ma liste','2017-04-15 00:00:00',NULL,16);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (18,'Ma liste','2017-04-15 00:00:00',NULL,15);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (19,'Ma liste','2017-04-15 00:00:00',NULL,14);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (20,'Ma liste','2017-04-15 00:00:00',NULL,13);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (21,'Ma liste','2017-04-15 00:00:00',NULL,10);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (22,'Ma liste','2017-04-15 00:00:00',NULL,9);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (23,'Ma liste','2017-04-15 00:00:00',NULL,8);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (24,'Ma liste','2017-04-20 00:00:00',NULL,4);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (25,'Ma liste','2017-04-20 00:00:00',NULL,3);
INSERT INTO `liste` (`id_liste`, `titre_liste`, `date_creation`, `date_valid`, `membre_id`) VALUES (26,'Ma liste','2017-04-20 00:00:00',NULL,2);
...
INSERT INTO `envie` (`id_envie`, `distance`, `liste_id`, `valeur_id`, `categorie_id`, `sous_categorie_id`, `intitule`) VALUES (13,5,8,5,10,NULL,'Vélo');
...
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (2,'2','2017-04-02 00:00:00','2017-04-03 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,5969,1,5,12,NULL);
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (3,'3','2017-04-01 00:00:00','2017-04-02 00:00:00','2017-04-03 00:00:00',NULL,NULL,NULL,NULL,NULL,9029,2,5,18,NULL);
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (4,4,'2017-04-26','2017-04-30',NULL,'2017-05-03','Tres bon contact',4,'Parfait',3,1235,3,12,37,NULL);
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (5,5,'2017-04-20','2017-05-01',NULL,'2017-05-06','A l écoute',4,'Un plaisir',5,4895,2,13,17,NULL);
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (6,6,'2017-04-03','2017-04-04',NULL,'2017-04-05','Trés réactif',4,'Vive le troc!',4,1656,1,14,30,NULL);
...
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (9,9,'2017-04-06','2017-04-07',NULL,'2017-04-08','Trés mignon',4,'Grognon',4,3546,1,17,32,NULL);
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (10,10,'2017-04-06','2017-04-07',NULL,'2017-04-08','Trés mignon',4,'Grognon',4,3541,1,5,28,NULL);
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (11,11,'2017-04-06',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3999,1,5,43,'2017-04-7');
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (12,12,'2017-03-20','2017-03-22',NULL,'2017-03-24','yeah',4,'youhhou',4,1454,4,1,44,NULL);
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (13,13,'2017-04-06','2017-04-07','2017-04-08',NULL,NULL,NULL,NULL,NULL,5959,3,1,45,NULL);
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (14,14,'2017-04-06','2017-04-07',NULL,NULL,NULL,NULL,NULL,NULL,4589,2,1,46,NULL);
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (15,15,'2017-05-06','2017-05-07',NULL,NULL,NULL,NULL,NULL,NULL,3434,3,1,47,'2017-05-8');
INSERT INTO `echange` (`id_echange`, `reference_echange`, `date_init`, `date_acceptation`, `date_refus`, `date_validation`, `comm_chercheur`, `note_chercheur`, `comm_donneur`, `note_donneur`, `code_echange`, `prix`, `membre_id`, `proposition_id`, `date_annul`) VALUES (16,16,'2017-05-06','2017-05-07',NULL,'2017-05-11','sympa mais nulle en java!',4,'Ponctuel et livre en bon état!',3,5656,3,23,51,NULL);
...
INSERT INTO `rdv` (`id_rdv`, `date_annulation`, `commentaire`, `date_rdv`, `lieu`, `echange_id`) VALUES (4, NULL, 'RDV avec Agnes/Seb pour échange livre Java', '2017-05-16', 'Montrouge', 16);
...
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (2,'img/imgProposition/disqueDurSamsung1.jpg',2);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (3,'img/imgProposition/chaiseLouis16.jpg',3);
...
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (17,'img/imgProposition/cadenasRoyal1.jpg',13);
...
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (24,'img/imgProposition/trotinette.jpg',20);
...
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (50,'img/imgProposition/binette.jpg',44);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (51,'img/imgProposition/tondeuse.jpg',45);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (52,'img/imgProposition/pelle1.jpg',46);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (53,'img/imgProposition/potFleu.jpg',47);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (54,'img/imgProposition/disqueDurSamsung2.jpg',2);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (55,'img/imgProposition/bol03.jpg',11);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (56,'img/imgProposition/cadenasRoyal2.jpg',13);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (57,'img/imgProposition/pelle2.jpg',46);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (58,'img/imgProposition/anneau.jpg',48);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (59,'img/imgProposition/babyfoot1.jpg',49);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (60,'img/imgProposition/babyfoot2.jpg',49);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (61,'img/imgProposition/babyfoot3.jpg',49);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (62,'img/imgProposition/ordiSeb.jpg',50);
INSERT INTO `photo` (`id_photo`, `url`, `proposition_id`) VALUES (63,'img/imgProposition/javaNuls.jpg',51);
...
INSERT INTO `localiser` (`localisation_id`, `proposition_id`) VALUES (29,49);
INSERT INTO `localiser` (`localisation_id`, `proposition_id`) VALUES (32,50);
INSERT INTO `localiser` (`localisation_id`, `proposition_id`) VALUES (32,51);
INSERT INTO `localiser` (`localisation_id`, `proposition_id`) VALUES (33,48);
INSERT INTO `localiser` (`localisation_id`, `proposition_id`) VALUES (8,15);
...
INSERT INTO`departement` (`id_deptartement`, `nom_departement`, `num_departement`) VALUES (7,'Ardeche','7');
...
INSERT INTO `suggestion` (`id_suggestion`, `intitule`, `categorie_id`, `membre_id`, `sous_categorie_id`) VALUES ('1', NULL, '9', '5', '58');
